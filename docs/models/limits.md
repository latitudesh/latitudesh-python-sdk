...
| ----------------------- | ----------------------- | ----------------------- | ----------------------- |
| `bare_metal`            | *OptionalNullable[int]* | :heavy_minus_sign:      | N/A                     |
| `bare_metal_gpu`        | *OptionalNullable[int]* | :heavy_minus_sign:      | N/A                     |
...
| `bgp_session_per_ip`    | *OptionalNullable[int]* | :heavy_minus_sign:      | N/A                     |
...
| `block_storage`         | *OptionalNullable[int]* | :heavy_minus_sign:      | N/A                     |