...
class Plans(BaseSDK):
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return utils.unmarshal_json_response(models.GetPlansResponseBody, http_res)
    ...
    def get(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return utils.unmarshal_json_response(models.Plan, http_res)
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return models.GetBandwidthPlansResponse(
                result=utils.unmarshal_json_response(models.BandwidthPlans, http_res),
                next=next_func,
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
    ...
    def update_bandwidth(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return utils.unmarshal_json_response(models.BandwidthPackages, http_res)
    ...
    def list_storage(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return utils.unmarshal_json_response(models.StoragePlans, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    def list_vm_plans(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return utils.unmarshal_json_response(models.VirtualMachinePlans, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
