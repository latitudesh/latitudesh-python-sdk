...
class Plans(BaseSDK):
    ...
    def update_plans_bandwidth(
        ...
        *,
        request: Optional[
            Union[
                models.UpdatePlansBandwidthRequestBody,
                models.UpdatePlansBandwidthRequestBodyTypedDict,
            ]
        ] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, Optional[models.UpdatePlansBandwidthRequestBody]
            )
        request = cast(Optional[models.UpdatePlansBandwidthRequestBody], request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.UpdatePlansBandwidthRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
