...
class ElasticIpsSDK(BaseSDK):
    ...
    def list_elastic_ip_bgp_sessions(
        self,
        *,
        elastic_ip_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        ...
        request = models.ListElasticIPBgpSessionsRequest(
            elastic_ip_id=elastic_ip_id,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="list-elastic-ip-bgp-sessions",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
                tags=["Elastic Ips"],
                extensions={
                    "x-mint": {"href": "/api-reference/list-elastic-ip-bgp-sessions"}
                },
            ),
            request=req,
            is_error_status_code=lambda c: utils.match_status_codes(["4XX", "5XX"], c),
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return unmarshal_json_response(models.BgpSessions, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def list_elastic_ip_bgp_sessions_async(
        self,
        *,
        elastic_ip_id: str,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def create_elastic_ip_bgp_session(
        self,
        *,
        elastic_ip_id: str,
        data: Union[models.CreateBgpSessionData, models.CreateBgpSessionDataTypedDict],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.BgpSession:
        r"""Create a BGP session
        ...
        request = models.CreateElasticIPBgpSessionRequest(
            elastic_ip_id=elastic_ip_id,
            create_bgp_session=models.CreateBgpSession(
                data=utils.get_pydantic_model(data, models.CreateBgpSessionData),
            ),
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="create-elastic-ip-bgp-session",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
                tags=["Elastic Ips"],
                extensions={
                    "x-mint": {"href": "/api-reference/create-elastic-ip-bgp-session"}
                },
            ),
            request=req,
            is_error_status_code=lambda c: utils.match_status_codes(["4XX", "5XX"], c),
        ...
        if utils.match_response(http_res, "202", "application/vnd.api+json"):
            return unmarshal_json_response(models.BgpSession, http_res)
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
            raise models.APIError("API error occurred", http_res, http_res_text)
        if utils.match_response(http_res, "5XX", "*"):
    ...
    async def create_elastic_ip_bgp_session_async(
        self,
        *,
        elastic_ip_id: str,
        data: Union[models.CreateBgpSessionData, models.CreateBgpSessionDataTypedDict],
    ...
    def get_elastic_ip_bgp_session(
        self,
        *,
        elastic_ip_id: str,
        id: str,
        ...
        request = models.GetElasticIPBgpSessionRequest(
            elastic_ip_id=elastic_ip_id,
            id=id,
        )
        ...
        req = self._build_request(
            method="GET",
            path="/elastic_ips/{elastic_ip_id}/bgp_sessions/{id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="get-elastic-ip-bgp-session",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
                tags=["Elastic Ips"],
                extensions={
                    "x-mint": {"href": "/api-reference/get-elastic-ip-bgp-session"}
                },
            ),
            request=req,
            is_error_status_code=lambda c: utils.match_status_codes(["4XX", "5XX"], c),
    ...
    async def get_elastic_ip_bgp_session_async(
        self,
        *,
        elastic_ip_id: str,
        id: str,
    ...
    def delete_elastic_ip_bgp_session(
        self,
        *,
        elastic_ip_id: str,
        id: str,
        ...
        request = models.DeleteElasticIPBgpSessionRequest(
            elastic_ip_id=elastic_ip_id,
            id=id,
            force=force,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="delete-elastic-ip-bgp-session",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
                tags=["Elastic Ips"],
                extensions={
                    "x-mint": {"href": "/api-reference/delete-elastic-ip-bgp-session"}
                },
            ),
            request=req,
            is_error_status_code=lambda c: utils.match_status_codes(["4XX", "5XX"], c),
    ...
    async def delete_elastic_ip_bgp_session_async(
        self,
        *,
        elastic_ip_id: str,
        id: str,
