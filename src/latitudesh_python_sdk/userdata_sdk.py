...
class UserDataSDK(BaseSDK):
    ...
    def get_users_data(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.GetUsersDataResponse]:
        r"""List user data
        ...
        def next_func() -> Optional[models.GetUsersDataResponse]:
        ...
        if utils.match_response(http_res, "200", "application/vnd.api+json"):
            return models.GetUsersDataResponse(
                result=unmarshal_json_response(models.UserData, http_res),
                next=next_func,
            )
        if utils.match_response(http_res, "4XX", "*"):
            http_res_text = utils.stream_to_text(http_res)
