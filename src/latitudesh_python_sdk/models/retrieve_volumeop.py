...
class RetrieveVolumeRequestTypedDict(TypedDict):
    id: str
    r"""The volume ID"""


class RetrieveVolumeRequest(BaseModel):
    id: Annotated[
...
class RetrieveVolumeResponseBodyTypedDict(TypedDict):
    r"""Success"""

    data: NotRequired[VolumeDataTypedDict]


class RetrieveVolumeResponseBody(BaseModel):
    r"""Success"""
