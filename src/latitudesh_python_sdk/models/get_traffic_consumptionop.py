...
class GetTrafficConsumptionRequestTypedDict(TypedDict):
    ...
    filter_date_lte: str
    r"""The end timestamp to retrieve the traffic. You must provide in ISO8601 format. The period must not exceed 366 days. Example: filter[date][gte]=2024-04-31T23:59:59Z"""
...
class GetTrafficConsumptionRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = set(["filter[server]", "filter[project]"])
